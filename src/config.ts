...
export const lyrMints = {
    devnet: new PublicKey('Bb9bsTQa1bGEtQ5KagGkvSHyuLqDWumFUcRqFusFNJWC'),
    mainnet: new PublicKey('LyraeCzJ36AjZyKwVj3VnYU4GTonjfVEnJmvvWaxLac'),
};
...
function groupConfigFromJson(j: any) {
    return {
        ...j,
        publicKey: new PublicKey(j.publicKey),
        lyraeProgramId: new PublicKey(j.lyraeProgramId),
...
function groupConfigToJson(g: GroupConfig): any {
    return {
        ...
        lyraeProgramId: g.lyraeProgramId.toBase58(),
